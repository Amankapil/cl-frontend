...
const HomeAbout = ({ isDarkMode, toggleDarkMode, handleButtonHover }) => {
  ...
  useEffect(() => {
    ...
    const sections = document.querySelectorAll(".home-hero-right");
    sections.forEach((section) => {
      new ScrollMagic.Scene({
        triggerElement: section,
        triggerHook: 1,
        ...
        .on("enter", () => {
          TweenMax.to(section, 0, { opacity: 1, x: 0, ease: "easeIn" });
        })
        .addTo(controller);
    });
  }, []);
  ...
  useEffect(() => {
    ...
    const sections = document.querySelectorAll(".headingsection-btn");
    sections.forEach((section) => {
      new ScrollMagic.Scene({
        triggerElement: section,
        triggerHook: 1, // Adjust this value to control when the animation starts
  ...
  useEffect(() => {
    ...
    const sections = document.querySelectorAll(".come-from-right");
    sections.forEach((section) => {
      new ScrollMagic.Scene({
        triggerElement: section,
        triggerHook: 1, // Adjust this value to control when the animation starts
      ...
      <section id="about" className=" agency mt-16 max-sm:mt-0">
        ...
        <div id="abtcnt">
          <div className="header1 ">
            ...
            <h1 style={{ color: isDarkMode ? "#000" : "#d8d6d6" }} id="abth1" className="headingsection">
          ...
          <p className="line-hero">  
          <div className="headingsection-btn">
          ...
          <Link
            ...
            to={"/work"}
            className="allwork CTAButton mt-5"
          >
            <p
        ...
        {Widht > 428 ? (
          <>
            <div className="bg-container">
              <div className="bg-mini-1 about-crew-left ">
              ...
              <div className="bg-mini-4 about-crew-left">
                <div id="imgs4">
              ...
              <div className="bg-mini-2  come-from-right">
                <div id="imgs"></div>
                <div id="imgs1">
                  <h1 style={{ color: isDarkMode ? "#00000099" : "#d8d6d6" }}>
                    COWBOY
              ...
              <div className="bg-mini-3 come-from-right">
                <div id="imgs3">
                  <h1 style={{ color: isDarkMode ? "#00000099" : "#d8d6d6" }}>
                    WILLAIM ABRAHAM
                  </h1>
          ...
          <div className="horizontalAbout">
            <div className="teshome w-[36rem] max-md:mt-20 max-sm:mt-20">
              <Swiper
                slidesPerView={3}
