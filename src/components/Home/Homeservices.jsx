   ...
   const sectionshead = document.querySelectorAll(".headingsection");
    sectionshead.forEach((section) => {
      new ScrollMagic.Scene({
        ...
        .on("enter", () => {
          TweenMax.to(section, 0.2, { opacity: 1, y: 0, ease: "easeOut" });
        })
        .addTo(controller);
    });
  }, []);
    ...
    <section id="service" className="">
      <div className="service_main">
        ...
        <p className="line-hero">  
          ...
          <p className="line-hero">  
          <div  className="headingsection max-xl:flex max-xl:items-center max-xl:justify-center">
          ...
          <Link
            ...
            to={"/services"}
            id="svcbtn"
            className="headingsection mt2 m"
          >
            <p
              // style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
