...
import image2 from "./images/Frame 43.webp";
import image3 from "./images/Frame 44.webp";
import image4 from "./images/Frame 472.webp";
import image5 from "../Blog/Images/Frame 45.webp";
import image6 from "../Blog/Images/Frame 47.webp";
import image7 from "../Blog/Images/Frame 46.webp";
...
const BlogHome = ({ isDarkMode, handleimgHover, handleButtonHover }) => {
  ...
  if (url.pathname === "/") {
      ...
      <>
        <div className="headingsection" id="blog">
          ...
          <div
            ...
            className="max-w[100%] w-[100%] mt-24 homeidea -ml-[6%] max-2xl:ml-0 max-xl:ml-8 max-sm:ml-0 max-sm:mt-5 headingsection"
          >
            <Swiper
              ref={swiperRef}
              slidesPerView={3}
            ...
            <div className=" flex justify-center items-center max-sm:mt-10 mt-4 -ml-0">
    ...
    return (
      <>
        <>
          <div id="blg" className="headingsection">
            <div className="flex justify-center flex-col items-center w-full">
              <h1
                style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
                className="head-meet mt-20 text-center font-bold max-md:p-10 max-sm:p-5"
              >
                Take A Peek At Our <br /> Case Study
              </h1>

              <p
                className="w-[28rem] text-center para mt-8 max-md:px-5 max-sm:w-full max-sm:pb-10"
                style={{
                  color: isDarkMode ? "#00000099" : "#848484",
                  fontFamily: "graphik",
                }}
            ...
            <div
              onMouseEnter={() => swiperRef.current.swiper.autoplay.stop()}
              onMouseLeave={() => swiperRef.current.swiper.autoplay.start()}
              className="max-w[100%] w-[100%] homeidea -ml-[0%] max-2xl:ml-8 max-sm:ml-0 -mt-20 "
            >
              <Swiper
                ref={swiperRef}
                slidesPerView={3}
