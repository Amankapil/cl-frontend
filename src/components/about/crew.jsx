...
export default function Crew({ isDarkMode, handleButtonHover }) {
  ...
  // useEffect(() => {
  //   axios.get("https://codelinear.in/code/aboutcrew_box").then((response) => {
  ...
  // useEffect(() => {
  //   const card = document.querySelectorAll(".c-container");

  //   gsap.to(card, {
  //     rotation: -20, // Negative value for clockwise rotation
  //     ease: "none",
  //     scrollTrigger: {
  //       trigger: ".crew-model-container",
  //       start: "top bottom",
  //       end: "bottom top",
  //       scrub: true,
  //     },
    ...
    <>
      <div className=" produc crewclass  ">
        <h2
          ...
          className=" meet-head max-xl:text-5xl max-xl:p-5 leading-sng font-extrabold ml max-md:p-0 max-md:ml-5 max-md:text-4xl"
        >
        ...
        <p
          ...
          className="my-10 texe w-2/5 max-lg:w-full max-xl:p-5 max-md:p-6 crewpara max-md:my-0"
        >
        ...
        <div className="crew-model">
          <div className="crew-model-container">
            <div
              ...
              className="c-container about-creweft skewElem"
            >
            ...
            <div
              style={{ backgroundColor: isDarkMode ? "#F6F6F2" : "#11111" }}
              className="c-container about-crew- skewElem"
            >
              <h1 className="m-title">
                <p
                  style={{ color: isDarkMode ? "#00000099" : "#d8d6d6" }}
