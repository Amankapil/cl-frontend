  ...
  return (
    <>
      ...
      <p className="line-hero">
        ...
        <div className="vision-container aboutsectio">
        {/* <p className="line-hero"> */}
          <h2
            style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
            className="visionh1 headingsection"
          >
            Our Vision
          </h2>
          {/* </p> */}
          ...
          <p
            style={{ color: isDarkMode ? "#00000099" : "#848484" }}
            className="vision-para headingsection"
          >
        ...
        <div className="core-guiding-container about-creweft ">
