export default function Trendsection({ isDarkMode, toggleDarkMode ,handleButtonHover }) {
  return (
    <section className="empathy-content-container">
      ...
      <div className="empathy-content">
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">Shopify</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Multi-channel integration</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- 100+ payment gateways</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- 1200+ apps</p>
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- No coding knowledge is required.</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Round-the-clock customer support</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
      ...
      <div className="empathy-content">
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">Magento</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Product support is expensive</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- May need coding</p>
