  ...
  return (
    <section className="empathy-content-container">
      ...
      <div className="empathy-content">
        ...
        >A no-code revolution is brewing</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
      ...
      <div className="empathy-content">
        ...
        >- Automates tasks</p>
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Can build and launch chatbots</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Custom mobile app development</p>
          </div>
        </p>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- No webview button on the main menu</p>
          </div>
        </p>
      </div>
      <div className="empathy-content">
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">2. Webflow</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Expensive for small businesses</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- No live chat or phone support</p>
          </div>
        </p>
      </div>
      <div className="empathy-content">
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">3. Bubble.io</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >- User-friendly</p>
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Free version has enough features</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Cannot test plugins before buying</p>
          </div>
        </p>
      </div>
      <div className="empathy-content">
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">4. Bildr</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Precoded building blocks</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Functional APIs to retrieve data </p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- May require some coding knowledge</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">5. Thunkable </h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Perfect for native apps building </p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Advanced logic workflow builder</p>
          </div>
        </p>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
