    ...
    <section className="empathy-content-container">
      ...
      <div className="empathy-content">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="empathy-h1"
        >Why are React and Flutter so popular?</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Apps are larger than native ones</p>
          </div>
        </p>
      </div>
      <div className="empathy-content">
        <h1 
        style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}className="empathy-sub-heading">Flutter </h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Offers a rich library of widgets</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Well-structured documentation</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Has rapidly growing community</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- Offers Hot Reload feature</p>
          </div>
        </p>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
      ...
      <div className="empathy-content">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="empathy-h1"
        >How to choose between the two?</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
