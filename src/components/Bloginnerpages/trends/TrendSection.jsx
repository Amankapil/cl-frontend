  ...
  return (
    <section className="empathy-content-container">
      ...
      <div className="empathy-content">
        ...
        >Customer experience over keywords</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- ease of inquiries, order placement</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
      ...
      <div className="empathy-content">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="empathy-h1"
        >Influencers aren’t going anywhere</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
      ...
      <div className="empathy-content">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="empathy-h1"
        >Linked-in is a thought influencer in B2B</h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
      ...
      <div className="empathy-content">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="empathy-h1"
        >Not every trend is for your business </h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
      ...
      <div className="empathy-content">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="empathy-h1"
        >Keep focusing on your foundation </h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >
        ...
        >
          ...
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- a scalable mobile application</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- decent presence on social media</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
        >- a clear brand voices</p>
            <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="empathy-para"
