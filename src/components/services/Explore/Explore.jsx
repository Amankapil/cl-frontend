...
const Explore = ({ isDarkMode, handledrag,  handleimgHover, }) => {
  ...
  if (url.pathname === "/consultingandstrategy") {
    return (
      <>
        <div  onMouseEnter={handleimgMouseEnter}
            onMouseLeave={handleimgMouseLeave} className="lead flex mt-40 justify-center h-full relative  items-center">
          <div
           onMouseEnter={handleimgMouseEnter}
            onMouseLeave={handleimgMouseLeave} className="width w-full flex-col min n h-full  relative">
            <div className="headifn flex justify-start items-start w-full">
              <h1
                className="head-meet w-2/3  max-lg:text-5xl max-lg:w-full font-extrabold max-xl:p-5"
            ...
            onMouseLeave={handleimgMouseLeave}
                  to="/userexperience" className="px20cursorgrab">
                    <div className="card1 m48 max-md:mx-0 hideee relativecursorgrab">
                ...
                <SwiperSlide className="flex justify-center items-center">
                 ...
                 onMouseEnter={handleimgMouseEnter}
            onMouseLeave={handleimgMouseLeave}
                 to="/productdevelopment" className="px20cursorgrab">
                    <div className="card1 mx48 max-md:mx-0 hideee relativecursorgrab">
                ...
                onMouseEnter={handleimgMouseEnter}
            onMouseLeave={handleimgMouseLeave} 
                 to="/digitalmarketing" className="px20cursorgrab">
                    <div className="card1 ml48 max-md:mx-0 hideee relativecursorgrab">
          ...
          <div className="width w-full flex-col min n h-full  relative">
            ...
            <div className="cards tett p-10  w-[100%] max-lg:p-0">
              <Swiper
                ...
                modules={[FreeMode, Pagination]}
                className="mySwiper h-full  w-[115%] p-5 -ml-28 max-sm:-ml-10 max-lg:w-[100%] max-lg:ml-0cursorgrab"
              >
                <SwiperSlide className="flex justify-center items-center">
                  <Link
                onMouseEnter={handleimgMouseEnter}
            onMouseLeave={handleimgMouseLeave} 
                    ...
                    className="px20cursorgrab z-10"
                  >
                    <div className="card1  z-10 mx-4 max-md:mx-0 hideee relativecursorgrab">
            ...
            <div  className="cards tett p-10  w-ful max-lg:p-0">
              ...
              >
                ...
                onMouseLeave={handleButtonMouseLeave}  
                 to="/consultingandstrategy" className="px20 cursrab z0">
                    <div
                ...
                onMouseLeave={handleButtonMouseLeave}  
                to="/userexperience" className="px20 cursorgrab">
