...
export default function Services({
  ...
  // useEffect(() => {
  //   axios.get("https://codelinear.in/code/serviceability").then((response) => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="Services"
          content="Leading The Way From Strategy To Execution"
        />
        <link rel="canonical" href="https://www.codelinear.com/services" />
      </Helmet>
      <Navbar
