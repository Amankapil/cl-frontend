    ...
    <>
      <section id="hero_services" className="">
        <div className="vision w-full mb-52  flex justify-center h-full relative  items-center">
          <div className="wthh max-md:flex-col -mt-20 max-sm:ml-0   ml0 max-2xl:ml-0 max-xl:ml-0  max-md:ml-5 max-md:p-0  w-9/10 flex relative">

            <div className="line-heroservice   mt max-xl:ml-12 max-sm:ml-2 flex w-full max-md:ml-0  max-sm:flex-col">
              <h1
                className="text-6xl headingsection mt6 ml-4 max-2xl:ml-0 max-xl:mb-5 max-md:text-3xl font-extrabold text-white"
              ...
              <Swiper
                ...
                modules={[Autoplay]}
                className="mySwi -ml-5 max-2xl:-ml-4   width-class h-40 max-sm:h-20 max-sm:-ml-5 headingsection"
              >
