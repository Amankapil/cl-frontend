export default function Contacthero({ isDarkMode, toggleDarkMode ,handleButtonHover }) {
  return (
    <section className="contact-hero">
      <div className="contact-section">
        <h1
          style={{ color: isDarkMode ? "#000000" : "#d8d6d6" }}
          className="contact-hero-h1 headingsection"
        >
          The Sky's The Limit!​
        </h1>
        <p
          style={{ color: isDarkMode ? "#00000099" : "#848484" }}
          className="contact-hero-para headingsection-talk"
        >
