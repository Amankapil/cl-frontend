...
//   // let section = gsap.utils.toArray(".hidee")


//   useEffect(() => {
//     const section = document.querySelectorAll('.hidee');
//     const testElement = document.querySelector('#myDiv');

//     if (section.length > 0 && testElement) {
//       gsap.to(section, {
//         xPercent: -50 * (section.length - 1),
//         ease: 'none',
//         scrollTrigger: {
//           trigger: '#myDiv',
//           pin: true,
...
//                     <button
//                       className="my36 hover:text-black -20  "
//                       onClick={toggleCase}
//                     >
//                       <div className="exploree card111  max-md:mx-0 mx-10 ml-10 flex flex-col justify-cnter   p-10">
